...
<script>
  import approvalFollow from '../../../components/applyPro/approvalFollow'
  ...
  export default {
    ...
    methods: {
      ...
      getAppvalProc: function () {
        let arr = []
        for (let i in this.param.RefbillPhidList) {
          arr [i] = this.param.RefbillPhidList[i].PhId
        }
        let param = {
