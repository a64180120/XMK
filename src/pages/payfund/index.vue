<template>
  <div class="self">
    ...
    <div ref="container"
        ...
        <div style="width: 278px;overflow-y: scroll;padding-right: 11px;height: 100%;">
          ...
          <el-card>
            <div style="font-size: .15rem"
                 ...
                 :class="{showTil:rightShow.show1}">预算支出</div>
          ...
          <el-card>
            <div style="font-size: .15rem"
                 ...
                 :class="{showTil:rightShow.show2}">对下补助项目</div>
            <transition name="el-zoom-in-top">
      ...
      <div class="arrowShow"
           style="position: absolute;right: 285px;top: 47%;font-size: 33px;text-shadow: 0 0 10px #58a5e6;color: #58a5e6;transition: all .3s linear;"><i class="el-icon-d-arrow-right"
           @click.stop="arrowShow"></i></div>
    </div>
    ...
    <!--生成支付单-->
    <approval-dialog v-if="approvalData.openDialog"
                     ref="approvalDialog"
