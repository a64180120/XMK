  ...
  <div class="bankaccountAdd">
    <ul>
      ...
      <li>
        <div>银行账户名称:</div>
        <div>
          <el-input v-model="info.FBankname"
                    placeholder="请输入银行账户名称(必填)"></el-input>
        </div>
      </li>
      <li>
        <div>银行账号:</div>
        <div>
          <el-input v-model="info.FAccount"
                    minlength="19"
                    placeholder="请输入银行账号(必填)"></el-input>
        </div>
      </li>
      <li>
        <div>开户行:</div>
        <div>
          <el-input v-model="info.FOpenAccount"
                    placeholder="请输入开户行(必填)"></el-input>
        </div>
      </li>
      <li>
        <div>银行行号:</div>
        <div>
          <el-input v-model="info.FBankcode"
                    minlength="3"
                    placeholder="请输入银行行号(必填)"></el-input>
        </div>
      </li>
      <li>
        <div>所在城市名称:</div>
        <div>
          <el-input v-model="info.FCity"
                    placeholder="请输入所在城市(必填)"></el-input>
        </div>
      </li>
      <li>
        <div>启用/停用:</div>
        <div>
          <el-radio v-model="info.FLifecycle"
                    label='1'>启用</el-radio>
          <el-radio v-model="info.FLifecycle"
                    label='0'>停用</el-radio>
        </div>
