<template>
  <div class="post">
    <topHandle :title="'系统管理在线工作平台'"
               @refresh="refresh">
      <div class="btnCon">
        <div v-if="menuButton.postperson_add=='True'"
             @click.stop="showPostAdd('add')"
             class="handle">
          <div class="topIcon"><img src="@/assets/images/xz.png"
                 alt=""></div>
          新增
        </div>
        <div v-if="menuButton.postperson_edit=='True'"
             @click.stop="showPostAdd('update')"
             class="handle">
          <div class="topIcon"><img src="@/assets/images/zj2.png"
                 alt=""></div>
          修改
        </div>
        <div v-if="menuButton.postperson_delete=='True'"
        ...
        <div class="formArea">
                ...
                <tr>
                  <td @click.stop="allChecked('change')"
                    ...
                    <el-checkbox @click.stop.native="1"
                                 ...
                                 v-model="checked">序号</el-checkbox>
                  </td>
                  <td>
                    岗位代码
                  </td>
          ...
          <div class="tableBody">
            <table>
              ...
              <thead>
                <tr v-for="(post,n) in postList"
                    :key="n">
                  <td @click.stop="choose(post,'change')"
                      style="cursor:pointer;padding: 0 5px;">
                    <el-checkbox @click.stop.native="1"
                                 @change="choose(post)"
                                 v-model="post.checked">{{n+1}}</el-checkbox>
                  </td>
                  <td>
                  ...
                  <td class="postRadio">
                    <img v-if="post.GAppvalPost.FEnable==0"
