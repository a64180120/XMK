        ...
        <div class="next-approval">
          ...
          <div class="table">
            ...
            >
              ...
              <el-table-column prop="OperatorPhid" align="center" label="操作员编码"></el-table-column>
 ...
 * 4、isAgree:是否同意事件改变时触发 传递一个布尔值 ，ture为同意  false为不同意、、审批用
 * 属性：
 * 1、approvalFollow ，左边审批流程列表数据
 * 2、nextApprovaler，下一审批人列表数据
 * 3、backPersonnel，返回人员数据//审批用
 */
