<template>
  <div class="postAdd">
    <div class="title">
      <span @click.stop="$emit('add-cancle')"
      ...
      <li class="auditInfo clear">
        ...
        <div>
          <el-input v-model="info.FCode"
                    placeholder="请输入岗位代码(必填)"></el-input>
        </div>
      </li>
      <li class="auditInfo clear">
        <div>岗位名称</div>
        <div>
          <el-input maxlength="20"
                    v-model="info.FName"
                    placeholder="请输入岗位名称,20个字以内(必填)"></el-input>
        </div>
      </li>
      <li class="auditInfo clear">
        <div>备注</div>
    ...
    <el-dialog modal-append-to-body
               ...
               append-to-body
               title="选择操作员"
               :visible.sync="showAddAuditer">
      <auditer v-if="showAddAuditer"
               :info="userList"
               :getuser="users"
               @auditer-cancle="auditerCancle" />
    </el-dialog>
  </div>
</template>
