<template>
  ...
  <section class="prerojectturnItem">
    <div slot="title"
         class="dialog-title">
      <span style="float: left">项目确认执行</span>
    </div>
    <!-- 项目审核领导小组意见 -->
    <div class="line1">
      <h2 class="title">■项目审核领导小组意见</h2>
      <div class="content">
        <el-row>
    ...
    <!-- 党组会议意见 -->
    <div class="line2">
      <h2 class="title">■党组会议意见</h2>
      <div class="content">
        <el-input type="textarea"
                  show-word-limit
                  maxlength="100"
                  :rows="3"
                  placeholder="请输入党组会议意见，100字以内。"
                  v-model="textarea"></el-input>
      </div>
    </div>
    <!-- 主席办公意见 -->
    <div class="line2">
      <h2 class="title">■主席办公意见</h2>
      <div class="content">
        <el-input type="textarea"
                  show-word-limit
                  maxlength="100"
                  :rows="3"
                  placeholder="请输入主席办公意见，100字以内。"
                  v-model="textarea"></el-input>
      </div>
    </div>
    <!-- 备注 -->
