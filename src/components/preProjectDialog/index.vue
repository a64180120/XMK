        ...
        <ul>
          ...
          <li>
            ...
            <el-select v-model="projSurvey.projLeval" size="small" placeholder="必选">
              <el-option v-for="(item,idx) in projGroup.projLevalGroup" :key="idx" :label="item.DeftName"
          ...
          <li>
            ...
            <el-select v-model="projSurvey.applyDepart" size="small" placeholder="必选">
              <el-option v-for="(item,idx) in projGroup.applyGroup" :key="idx" :label="item.DeftName"
                         :value="item.DeftCode"></el-option>
            </el-select>
          </li>
          <li>
            ...
            <el-select v-model="projSurvey.bugedDepart" size="small" placeholder="必选">
              <el-option v-for="(item,idx) in projGroup.bugedDepartGroup" :key="idx" :label="item.DeftName"
                         :value="item.DeftCode"></el-option>
            </el-select>
          </li>
          <li>
            ...
            <el-select v-model="projSurvey.projAbbtribute" size="small" placeholder="必选">
              <el-option v-for="(item,idx) in projGroup.projAbbtributeGroup" :key="idx" :label="item.DeftName"
                         :value="item.DeftCode"></el-option>
            </el-select>
          </li>
          <li>
            ...
            <el-select v-model="projSurvey.keepTerm" size="small" placeholder="必选">
              <el-option v-for="(item,idx) in projGroup.keepTermGroup" :key="idx" :label="item.DeftName"
                         :value="item.DeftCode"></el-option>
            </el-select>
          </li>
          <li>
            ...
            <el-select v-model="projSurvey.payType" size="small" placeholder="必选">
              <el-option v-for="(item,idx) in projGroup.payTypeGroup" :key="idx" :label="item.DeftName"
                         :value="item.DeftCode"></el-option>
            </el-select>
          </li>
          <li>
          ...
          <li>
            ...
            <el-select v-model="projSurvey.xjEvaluate" size="small" placeholder="必选">
              <el-option v-for="(item,idx) in projGroup.xjEvaluateGroup" :key="idx" :label="item.label"
                ...
                <ul v-else v-for="(item,index) in budgetdetailData" :key="index">
                  ...
                  <li>
                    <el-select v-model="item.fundSorce" size="small" placeholder="必选">
                      <el-option v-for="(item,idx) in budgetDetail.fundSorceGroup" :key="idx" :label="item.label"
                                 :value="item.value"></el-option>
                    </el-select>
                  </li>
                  <li>
                    <el-select v-model="item.method" size="small" placeholder="必选">
                      <el-option v-for="(item,idx) in budgetDetail.fundPayGroup" :key="idx" :label="item.TypeName"
              ...
              <div class="listBottom-right">
                ...
                <ul>
                  <li v-for="(item,idx) in budgetDetail.fundSorceGroup">
                    ...
                    <span class="money">{{item.money|NumFormat}}</span>
                  </li>
                </ul>
              </div>
            </div>
