              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr v-for="(mx,index) in item.PaymentDtls">
                      ...
                      <td @click="showDetailPro(pindex,index)">{{mx.QtKmmc }}</td>
                      <td class="right" >
  ...
  export default {
    ...
    data(){
      return {
        ...
        time: 3,//倒计时
        projectList:[
          {proCode:'201900000419',proName:'测试123'}
        ],
        data: {
          applyBillName:'',
        ...
        PaymentXmDtl:[
          {
            PaymentXm:{
              XmMstPhid: '484190514000001',//（项目主表主键）
              XmProjcode: '201900000419', //（项目编码）
              XmProjname: '测试123', //（项目名称）
              FAmountTotal: '120', //（项目金额）
              FRemarks: 'lalala', //（备注）
            },
            PaymentDtls:[
              {
                XmMstPhid: '484190514000001', //（预算项目主表主键）
                BudgetdtlPhid: '484190514000010', //（预算明细主键）
                BudgetdtlName: 'mx1', //（预算明细名称）
                FDepartmentcode: '101.09', //（补助单位/部门）
                FDepartmentname: '法工部', //（补助单位名称）
                FAmount: '120', //（项目明细申请金额）
                FRemarks: '555', //（备注）
                QtKmdm: '201900000419', //（预算项目编码）
                QtKmmc: '测试123' , //（预算项目名称）
